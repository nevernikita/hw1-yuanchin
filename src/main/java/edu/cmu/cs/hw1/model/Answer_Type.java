 ...
 * @generated */
public class Answer_Type extends AnnotationType_Type {
  /** @generated */
  @Override
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.cs.hw1.model.Answer");
  ...
  public boolean getIsCorrect(int addr) {
      ...
      jcas.throwFeatMissing("isCorrect", "edu.cmu.cs.hw1.model.Answer");
