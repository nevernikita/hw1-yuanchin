 ...
 * @generated */
public class AnswerScore extends AnnotationType {
  /** @generated
   * @ordered 
   */
  ...
  /** getter for score - gets Record the score assigned to the answer.
   * @generated */
  public double getScore() {
    if (AnswerScore_Type.featOkTst && ((AnswerScore_Type)jcasType).casFeat_score == null)
      jcasType.jcas.throwFeatMissing("score", "edu.cmu.cs.hw1.model.AnswerScore");
    return jcasType.ll_cas.ll_getDoubleValue(addr, ((AnswerScore_Type)jcasType).casFeatCode_score);}
    
  /** setter for score - sets Record the score assigned to the answer. 
   * @generated */
  ...
  /** getter for answer - gets Indicate which answer the score is assigned to.
   * @generated */
  public Answer getAnswer() {
    if (AnswerScore_Type.featOkTst && ((AnswerScore_Type)jcasType).casFeat_answer == null)
      jcasType.jcas.throwFeatMissing("answer", "edu.cmu.cs.hw1.model.AnswerScore");
  ...
  /** setter for answer - sets Indicate which answer the score is assigned to. 
   * @generated */
