...
/** Annotate an answer score to each answer.
 * Updated by JCasGen Wed Sep 11 21:16:56 EDT 2013
 * @generated */
public class AnswerScore_Type extends AnnotationType_Type {
  /** @generated */
  @Override
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.cs.hw1.model.AnswerScore");
  ...
  public double getScore(int addr) {
      ...
      jcas.throwFeatMissing("score", "edu.cmu.cs.hw1.model.AnswerScore");
  ...
  public int getAnswer(int addr) {
      ...
      jcas.throwFeatMissing("answer", "edu.cmu.cs.hw1.model.AnswerScore");
  ...
  public AnswerScore_Type(JCas jcas, Type casType) {
    ...
    casFeat_answer = jcas.getRequiredFeatureDE(casType, "answer", "edu.cmu.cs.hw1.model.Answer", featOkTst);
