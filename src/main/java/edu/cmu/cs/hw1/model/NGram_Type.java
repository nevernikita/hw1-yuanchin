 ...
 * @generated */
public class NGram_Type extends AnnotationType_Type {
  /** @generated */
  @Override
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.cs.hw1.model.NGram");
  ...
  public int getElements(int addr) {
      ...
      jcas.throwFeatMissing("elements", "edu.cmu.cs.hw1.model.NGram");
  ...
  public String getElementType(int addr) {
      ...
      jcas.throwFeatMissing("elementType", "edu.cmu.cs.hw1.model.NGram");
